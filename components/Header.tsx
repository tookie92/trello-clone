  ...
  return (
    <header>
      ...
      rounded-b-2xl'>
        ...
        '>
          {/* Search box */}
          <form className='flex flex-row items-center space-x-5 bg-white rounded-md 
          ...
          {/* Avatar */}
          <Avatar name='Joseph ikinda' round size='50' color='#0055d1' />
        </div>
      </div>

      {/* <div className='flex items-center justify-center px-5 py-2 md:py-5'>
        <p className='flex items-center p-5 text-sm font-light pr-5 shadow-xl
          rounded-xl w-fit italic bg-white max-w-3xl  text-[#0055d1]
        '>
